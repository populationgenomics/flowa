...
/**
 * Google Vertex AI provider (`google-cloud`) — Gemini via Vertex (GCP
 * service-account auth). For the public key-based API, use `./google`.
 *
 ...
 * shape matches.
 *
 * No `prepareStep`: same reasoning as `./google` — Vertex's explicit
